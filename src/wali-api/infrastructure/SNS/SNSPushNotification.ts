...
import { IPushNotification } from './../../application'
...
export default class SNSPushNotification implements IPushNotification
{
    ...
    execute(memberDetail: any, deviceType: string, awsEndpointARN:string, pushType: string, message: string )
    {
