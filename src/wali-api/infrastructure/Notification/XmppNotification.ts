...
import { INotification } from './../../application'
import { Message, Member } from './../../domain'


export default class XmppNotification implements INotification{
    ...
    send(messages : Message[], member : Member, senderProfile : { [key : string] : any }, debug? : boolean) {
        ...
        this._client.on('online', () => {
			...
			messages.forEach((message) => {
				...
				var stanza = new Client.Stanza('message', {to: message.memberHashId + '@' + this._host, type: 'chat'})
